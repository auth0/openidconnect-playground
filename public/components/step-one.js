...
class StepOne extends React.Component {
  ...
  render() {
    ...
    return (
      <div
        className={`playground-step ${this.state.isActiveStep ? "active" : ""}`}
      >
          ...
          <div className="code-box">
            ...
            <div className="code-box-content">
              <div className="code-block">
                <a
                  onClick={() => {
                    this.props.openModal(true, "authEndpoint");
                  }}
                  href="#"
                >
                  {" "}
                ...
                <div className="code-block-url-params">
                  ...
                  <a
                    onClick={() => {
                      this.props.openModal(true, "clientID");
                    }}
                    href="#"
                  >
                    {this.props.clientID}
                  ...
                  <a
                    onClick={() => {
                      this.props.openModal(true, "scopes");
                    }}
                    href="#"
                  >
                    {this.props.scopes}
                  ...
                  {this.props.audience && (
                    <a
                      onClick={() => {
                        this.props.openModal(true, "audience");
                      }}
                      href="#"
                    >
                      {this.props.audience}
              ...
              {this.state.stepState !== "wait" ? (
                <button onClick={this.start} className="code-box-btn">
                  Start
                </button>
              ) : null}
            </div>
