...
const MODAL_OPTIONS: ModalOptions[] = [
  ...
  },
  {
    name: "domain",
    title: "Domain",
    defaultValue: "openidconnectnet.us.auth0.com",
    type: "input",
  },
  {
    name: "authEndpoint",
    title: "Endpoint",
    defaultValue: "openidconnectnet.us.auth0.com/authorize",
    type: "input",
    readOnly: true,
  },
  {
    ...
    defaultValue: "openidconnectnet.us.auth0.com/oauth/token",
    type: "input",
    readOnly: true,
  },
  {
...
export const ConfigurationModal = ({
  ...
  const SERVER_URLS: Record<string, string> = {
    auth0: "https://openidconnectnet.us.auth0.com/.well-known/openid-configuration",
    ...
    try {
      ...
      setFormValues((prev) => {
        return {
          ...
          domain: value !== "auth0" ? SERVER_URLS[value] : "openidconnectnet.us.auth0.com",
        };
      });
    } catch (error) {
      setIsLoading(false);
